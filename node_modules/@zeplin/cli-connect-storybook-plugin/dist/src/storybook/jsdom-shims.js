...
exports.addShimsToJSDOM = void 0;
const eventsourcemock_1 = __importDefault(require("eventsourcemock"));
...
function addShimsToJSDOM(window) {
    ...
    Object.defineProperty(window, "customElements", {
        value: {
            ...
            upgrade: () => { },
            whenDefined: name => new Promise(resolve => {
                customElements[name] = customElements[name] || { resolvers: [] };
                if (customElements[name].constructor)
                    resolve();
                else
                    customElements[name].resolvers.push(resolve);
            }),
        },
        writable: false,
    });
    Object.defineProperty(window, "EventSource", {
        value: eventsourcemock_1.default,
        writable: false
    });
...
exports.addShimsToJSDOM = addShimsToJSDOM;
//# sourceMappingURL=jsdom-shims.js.map